...
-- 2. Remove plaintext AI credentials from database
ALTER TABLE public.company_settings DROP COLUMN IF EXISTS ai_api_key;
ALTER TABLE public.company_settings DROP COLUMN IF EXISTS ai_provider;

-- 3. Restrict SECURITY DEFINER functions from anon/public callers
